...
const surgicallyBestScore =
  ...
  return (
    <section className="solo-page">
      ...
      <button
        ...
        onClick={() => navigate('/')}
      >
        <span aria-hidden="true">←</span> {t('settings.backToHome')}
      </button>
      ...
      <div className="solo-heading">
        ...
        <h1>
          {t('menu.choose')} <span>{t('menu.challenge')}</span>
        </h1>

        <p className="solo-subtitle">
          {t('menu.soloDescription')}
        </p>
      </div>
  ...
  {ecgBestScore}
            ...
            <button
  type="button"
  onClick={() => navigate('/solo/ecg')}
>
  {t('home.play')} <span>→</span>
</button>
        ...
        <article className="solo-game-card">
            ...
            <div className="solo-specialty-icon">
              <svg viewBox="0 0 256 256" aria-hidden="true">
                <path
                  ...
                  c3.1-4.7,1.8-11.1-2.9-14.3l-15.6-10.3l-10.2-6.7l7.3-20h10l-5.9,16.2l19.6,12.9
                  c4.4,2.9,7.4,7.3,8.5,12.5c1.1,5.2,0,10.4-2.9,14.8c-1.2,1.8-2.6,3.3-4.2,4.5h27.1
                  c-1.6-1.3-3-2.8-4.2-4.5c-2.9-4.4-3.9-9.7-2.9-14.8c1.1-5.2,4.1-9.6,8.5-12.5
                  l19.6-12.9L172.9,98h10l7.3,20l-10.2,6.7l-15.6,10.3c-4.7,3.1-6.1,9.5-2.9,14.3
          ...
          <div className="solo-card-content">
            ...
            <h2>Surgically Insane</h2>

            <p className="solo-description">
              {t('menu.surgeryDescription')}
            </p>
  ...
  <div className="solo-best-score">
    ...
    <strong>
      {surgicallyBestScore.toLocaleString(language)}
    </strong>
  ...
  <button
    type="button"
    onClick={() =>
      navigate('/solo/surgically-insane')
    }
  >
    {t('home.play')} <span>→</span>
  </button>
...
<article className="solo-game-card">
  ...
  <div className="solo-card-bottom">
    ...
    <div className="solo-best-score">
      ...
      <strong>
        {stockAndStackBestScore.toLocaleString(
          language,
        )}
      </strong>
