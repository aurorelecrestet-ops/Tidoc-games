      ...
      {gameState === 'playing' && (
        ...
        <div className="stock-playing-screen">
          ...
          <div className="stock-topbar">
            ...
            <div className="stock-best-score">
            ...
            <div className="stock-current-score">
...
<div className="stock-leaderboard">

  <div className="stock-leaderboard-heading">

    <div>

      <span className="stock-leaderboard-kicker">
    ...
    <div className="stock-leaderboard-trophy">
  ...
  {leaderboardLoading ? (
    ...
    <div className="stock-leaderboard-loading">
          ...
          return (
            ...
            <div
              ...
              className={
                `stock-ranking-row ${
                  rank <= 3
                    ? `stock-ranking-top stock-ranking-${rank}`
                    : ''
                } ${
            ...
            >
              ...
              <div className="stock-ranking-position">
              ...
              <img
                className="stock-ranking-avatar"
              ...
              <div className="stock-ranking-player">
              ...
              <div className="stock-ranking-score">
