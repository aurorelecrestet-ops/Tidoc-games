...
function StockAndStackMultiplayer() {
  ...
  async function handleCreateGame() {
    ...
    try {
      ...
      navigate(
        `/multiplayer/stock-and-stack/lobby/${room.code}`,
      )

    } catch (error) {

      console.error(
        'Erreur création Stock & Stack :',
        error,
      )
  ...
  async function handleJoinGame() {
    ...
    try {
      ...
      /*
        ...
        bien à une partie Stock & Stack.

        Cela évite d'envoyer un joueur
        dans le lobby pharmacie avec
        le code d'un autre jeu.
      */
      ...
      if (
        ...
        throw new Error(
          'Ce code appartient à un autre jeu.',
        )
      ...
      /*
        La fonction commune ajoute
        le joueur à la salle, ou reconnaît
        qu'il l'a déjà rejointe.
      */
...
export default StockAndStackMultiplayer
