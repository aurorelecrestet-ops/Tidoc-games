...
<div className="solo-card-bottom">
  ...
  <button
    type="button"
    onClick={() =>
      navigate('/multiplayer/surgically-insane')
    }
  >
    {t('home.play')} <span>→</span>
  </button>
    ...
    >
      ...
      />
          ...
          <div className="solo-card-content">
            ...
            <h2>Bacteria Slash</h2>

            <p className="solo-description">
  {t('menu.bacteriaMultiplayerDescription')}
</p>
...
<article className="solo-game-card">
  ...
  <div className="solo-card-content">
    ...
    <p className="solo-description">
      {t('menu.stockMultiplayerDescription')}
    </p>
