...
function RankBadge({
  ...
  /* ========================================
     À PARTIR DE LA 4e PLACE
  ======================================== */

  if (rank > 3) {

    return (
      <span className="rank-badge-number">
        {rank}
      </span>
    )
  }
